     ...
     { isOpen &&(
      ...
      <div  className="relative mt-4 md:hidden animate-slide-down">
        <div className="px-6 py-4 space-y-4">
          <Link to="/" className="block hover:text-cyan-400 transition-colors" onClick={() => setIsOpen(false)}>HOME</Link>
          <a href="#about" className="block hover:text-cyan-400 transition-colors" onClick={() => setIsOpen(false)}>ABOUT</a>
          <a href="#skills" className="block hover:text-cyan-400 transition-colors" onClick={() => setIsOpen(false)}>SKILLS</a>
          <a href="/project" className="block hover:text-cyan-400 transition-colors" onClick={() => setIsOpen(false)}>PROJECTS</a>
          <a href="#contact" className="block hover:text-cyan-400 transition-colors" onClick={() => setIsOpen(false)}>CONTACT</a>
        </div>
      </div>
      )}
    </nav>
