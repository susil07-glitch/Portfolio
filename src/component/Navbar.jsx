...
const Navbar = () => {
  ...
  return (
    <div>
      ...
      />
      {/* Matrix Background */}
      <div className="matrix-code blur-md" id="matrix" />
      ...
      />
      {/* Navigation */}
      <nav className="fixed top-2.5 w-full sm:w-200 lg:w-330 lg:ml-20 z-50 bg-cyan-700  rounded-2xl">
        <div className="max-w-6xl mx-auto px-5  lg:px-6">
          <div className="flex items-center justify-between h-15">
            ...
            <div className="hidden items-center sm:flex sm:text-xs md:gap-1 space-x-8">
              <Link
                to="/"
              ...
              <div 
               className= " flex justify-center items-center bg-amber-500 h-10 w-20 rounded-full  "
               >
                <Link
                to="/"
                className="hover:text-cyan-400 transition-all duration-300 relative group"
