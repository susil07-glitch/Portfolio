            ...
            <div className="grid md:grid-cols-2 gap-12">
              <div className="fade-">
                ...
                <p className="text-lg text-gray-300 mb-8">
                  ...
                  and build something extraordinary together. Whether you need a
                  cutting-edge web application, mobile solution, or innovative
                  tech consultation, I'm here to help bring your vision to life.
                </p>
                <div className="space-y-6">
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <a href="https://www.google.com/maps/place/Dharan/@26.7951806,87.1937086,12z/data=!3m1!4b1!4m6!3m5!1s0x39ef419fc7271c1d:0x1d1300367590c002!8m2!3d26.806497!4d87.2847086!16zL20vMDRud3cz?entry=ttu&g_ep=EgoyMDI1MDcyMC4wIKXMDSoASAFQAw%3D%3D">
                        {" "}
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <a href="https://www.linkedin.com/in/sushil-sharma-5389b9321/">
                        <div className="text-cyan-400">
                          https://www.linkedin.com/in/sushil-sharma-5389b9321/
                        </div>
                      </a>
                    </div>
                  </div>
              ...
              <div className="fade-">
                <form
                  ref={form}
                  onSubmit={sendEmail}
                  className="hologram p-8 rounded-lg space-y-6"
                >
